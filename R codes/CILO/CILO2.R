...
plot(ns,prop.mc[1,],ylim=c(0,1), type="b",col=1, ylab = "Proportion", xlab = "Sample size", 
     main = "Empirical Coverage", xaxt = "n")
axis(1, at=ns)
for(i in 2:length(theta)){
  points(ns,prop.mc[i,],ylim=c(0,1), type="b",col=i)
}
...
plot(ns,prop.mc[1,],ylim=c(0.92,1), type="b",col=1, ylab = "Proportion", xlab = "Sample size", 
     main = "Empirical Coverage", xaxt = "n")
axis(1, at=ns)
for(i in 2:length(theta)){
  points(ns,prop.mc[i,],ylim=c(0.92,1), type="b",col=i)
}
abline(h = 0.95, col="red", lwd=3)
